...
"use strict";function e(e){return void 0===e&&(e=""),document.createComment(e)}function t(e){return void 0===e&&(e=""),document.createTextNode(e)}function r(e){return!!e&&!!e.nodeType}function o(e,t){var r=[].concat(t),o=r[0],i=r[1];o.parentNode&&(i&&o.nextSibling!==i&&n(o.nextSibling,i),o.parentNode.replaceChild(e,o))}function n(e,t,r){if(void 0===t&&(t=null),void 0===r&&(r=e.parentNode),r)for(;e!==t;){var o=e.nextSibling;r.removeChild(e),e=o}}function i(e,t,r){void 0===r&&(r=t.parentNode);var o=e.range,n=o[0],i=o[1],s=t.nextSibling,p=n;do{var x=p.nextSibling;r.insertBefore(p,s),p=x}while(p!==i);r.insertBefore(i,s)}function s(e){for(var t=0;e=e.previousSibling;)t++;return t}function p(e){for(var t=[];e.parentNode;)t.unshift(s(e)),e=e.parentNode;return t}function x(e,t){for(var r=0,o=t.length;r<o;r++)e=e.childNodes[t[r]];return e}function a(e,t){return d(e)&&d(t)&&e.strings===t.strings}function d(e){return e&&e[exports.TemplateSymbol]}function u(e){var t=exports.MARKER_RE.exec(e);return exports.MARKER_RE.lastIndex=0,t?Number(t[1]||t[2]):-1}exports.__esModule=!0,exports.comment=e,exports.text=t,exports.isNode=r,exports.replaceRange=o,exports.removeNodes=n,exports.moveTemplate=i,exports.getNodeIndex=s,exports.getNodePath=p,exports.getNodeByPath=x,exports.TemplateSymbol=Symbol(),exports.isTemplateEqual=a,exports.isTemplate=d,exports.MARKER_PREFIX="__"+Math.random().toString().slice(2)+"_",exports.MARKER_RE=new RegExp("\x3c!--"+exports.MARKER_PREFIX+"(\\d+)--\x3e|"+exports.MARKER_PREFIX+"(\\d+)"),exports.TEXT_ELEMENT=/^(?:style|textarea)$/i,exports.markerNumber=u;
...
"use strict";exports.__esModule=!0;var n=require("./types"),r=[],e=[],o=!1,t=0,i=!0;function s(n,r){for(var e=0;r-performance.now()>0&&e<n.length;){var o=n[e++];o.task.apply(o,o.args),o.args=void 0,o.pending=!1}n.splice(0,e)}function a(){o=!0,requestAnimationFrame(function(){t++;var n=performance.now()+10*Math.ceil(.02*t);s(r,n),s(e,n),r.length>0&&(e.push.apply(e,r),r.length=0),e.length>0?a():(o=!1,t=0)})}function p(n){i=n}function u(t,i){t.pending=!0,i===n.JobPriority.Normal?r.push(t):i===n.JobPriority.Low&&e.push(t),o||a()}function l(r,e){void 0===e&&(e=n.JobPriority.Normal);var o={task:r,args:[],pending:!1,firstRun:!0};return function(){for(var n=[],t=0;t<arguments.length;t++)n[t]=arguments[t];o.firstRun||!i?(o.firstRun=!1,r.apply(void 0,n)):(o.args=n,o.pending||u(o,e))}}exports.setEnabled=p,exports.enqueueJob=u,exports.scheduled=l;
},{"./types":"ltjX"}],"bRxU":[function(require,module,exports) {
"use strict";exports.__esModule=!0;var e=require("./utils"),t=require("./scheduler"),a=function(){return function(e,a,n){var r=this;this.element=e,this.name=a,this.namespaceURI=n,this.update=t.scheduled(function(e){if(r.value!==e){var t=r,a=t.name,n=t.element,i=t.namespaceURI;"ownerSVGElement"in n?n.setAttributeNS(i,a,e):a in n?n[a]=e:void 0!==e?n.setAttribute(a,e):n.hasAttribute(a)&&n.removeAttribute(a),r.value=e}})}}();exports.AttributeExpression=a;var n=function(){function a(a){var n=this;this.update=t.scheduled(function(t){if(t!==n.value){var a=n,r=a.element,i=a.placeholder;"object"!=typeof t&&r.nodeType===Node.TEXT_NODE?r.textContent=t:e.isTemplateEqual(t,r)?r.update(t.values):Array.isArray(t)?(n.value instanceof Map||r.nodeType===Node.COMMENT_NODE||n.replaceWith(i),t=n.updateArray(t)):n.replaceWith(null==t?i:t),n.value=t}}),this.element=this.placeholder=a}return a.prototype.updateArray=function(t){var a=this.value instanceof Map?this.value:new Map,n=this.element,r=t.reduce(function(t,r,i){var s=String(r.key||i),u=a.get(s);if(u)e.isTemplateEqual(u,r)?u.update(r.values):(e.replaceRange(r.create(),u.range),a.set(s,u=r));else{var l=r.create();n.parentNode.insertBefore(l,n.nextSibling),a.set(s,u=r)}return n.nextSibling!==u.range[0]&&e.moveTemplate(u,n),n=u.range[1],t.push(s),t},[]);return a.forEach(function(e,t,a){-1===r.indexOf(t)&&(e.delete(),a.delete(t))}),a},a.prototype.replaceWith=function(t){var a=this.element,n=this.value;n instanceof Map&&(n.forEach(function(e){return e.delete()}),n.clear()),a!==t&&(this.element=t=e.isTemplate(t)?t:e.isNode(t)?t:e.text(t),e.replaceRange(e.isTemplate(t)?t.create():t,e.isTemplate(a)?a.range:a))},a}();exports.NodeExpression=n;
},{"./utils":"K4Wa","./scheduler":"IJbV"}],"6dJP":[function(require,module,exports) {
"use strict";exports.__esModule=!0;var e=require("./expressions"),t=require("./utils");function r(){return NodeFilter.FILTER_ACCEPT}function n(r,n){for(var o=r.attributes,a=o.length;a--;){var i=o.item(a),s=i.name,u=i.value,d=i.namespaceURI,N=t.markerNumber(u);~N&&(r.removeAttribute(s),n[N]={type:e.AttributeExpression,name:s,namespaceURI:d,nodePath:t.getNodePath(r)})}}function o(r,n){var o=t.markerNumber(r.data);~o&&(n[o]={type:e.NodeExpression,nodePath:t.getNodePath(r)},r.nodeValue="")}function a(r,n){for(var o;null!==(o=t.MARKER_RE.exec(r.data));){var a=t.text();(r=r.splitText(o.index)).deleteData(0,o[0].length),r.parentNode.insertBefore(a,r),n[Number(o[1]||o[2])]={type:e.NodeExpression,nodePath:t.getNodePath(a)}}}function i(e){for(var i=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_COMMENT,r,!1),s=[];i.nextNode();){var u=i.currentNode;u.nodeType===Node.ELEMENT_NODE?(n(u,s),t.TEXT_ELEMENT.test(u.tagName)&&[].forEach.call(u.childNodes,function(e){return a(e,s)})):o(u,s)}return s}function s(e,r){return r.map(function(r){return new r.type(t.getNodeByPath(e,r.nodePath),r.name,r.namespaceURI)})}r.acceptNode=r,exports.linkAttributes=n,exports.linkComment=o,exports.linkTexts=a,exports.linkExpressions=i,exports.resolve=s;
},{"./expressions":"bRxU","./utils":"K4Wa"}],"gHUc":[function(require,module,exports) {
"use strict";exports.__esModule=!0;var e=require("./linker"),n=require("./utils"),t=new WeakMap;function r(n,t){var r=document.createElement("template");r.innerHTML=t?"<"+t+">"+n+"</"+t+">":n;var s=r.content;if(t){var a=document.createRange();a.selectNodeContents(s.firstChild),s=a.extractContents()}return{content:s,expressions:e.linkExpressions(s)}}function s(e){var t,r=new RegExp("^[^]*<([0-9a-z-]+)(?:\\s*[^<\\s\\0\"'>\\/=]+(?:\\s*=\\s*(?:\"[^\"]*\"?|'[^']*'?|[^\\s'\">]*))?)*\\s*(>?)|[^]*(>)[^]*|[^]*$","i");!function(e){e[e.TagName=1]="TagName",e[e.ClosedTag=2]="ClosedTag",e[e.EndTag=3]="EndTag"}(t||(t={}));for(var s=!1,a=e[0],o=0,i=e.length;o<i-1;o++){var c=""+n.MARKER_PREFIX+o,u=e[o].match(r);u[t.TagName]?s=!u[t.ClosedTag]:u[t.EndTag]&&(s=!1),a+=(s?c:"\x3c!--"+c+"--\x3e")+e[o+1]}return a}function a(n,a){var o=t.get(n);o||t.set(n,o=r(s(n),a));var i=document.importNode(o.content,!0);return{fragment:i,expressions:e.resolve(i,o.expressions)}}exports.parseTemplate=a;
},{"./linker":"6dJP","./utils":"K4Wa"}],"EMxn":[function(require,module,exports) {
"use strict";var e;exports.__esModule=!0;var t=require("./parser"),s=require("./utils"),i=function(){function i(t,s,i){this[e]=!0,this.values=s,this.strings=t,this.context=i}return i.prototype.withKey=function(e){return this.key=e,this},i.prototype.update=function(e){for(var t=0;t<e.length;t++)void 0!==this.expressions[t]&&this.expressions[t].update(e[t])},i.prototype.delete=function(){s.removeNodes(this.range[0],this.range[1].nextSibling),this.range=void 0,this.expressions=void 0},i.prototype.create=function(){var e=t.parseTemplate(this.strings,this.context),i=e.fragment,r=e.expressions;return this.expressions=r,this.range=[i.insertBefore(s.text(),i.firstChild),i.appendChild(s.text())],this.update(this.values),i},i}();e=s.TemplateSymbol,exports.Template=i;
...
"use strict";var t=this&&this.__assign||function(){return(t=Object.assign||function(t){for(var r,e=1,n=arguments.length;e<n;e++)for(var o in r=arguments[e])Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o]);return t}).apply(this,arguments)};exports.__esModule=!0;var r=require("./history"),e=/\/:([\w]+)(?:{([\w,]+)})?(\?)?/g;function n(t){var r,n=[],o=t;if("*"===t)return{regex:/.*/,params:[]};for(;r=e.exec(t);){var i=r[2]?""+r[2].split(",").join("|"):"[^/]+";n.push(r[1]),o=o.replace(r[0],"(?:\\/("+i+"))"+(r[3]?"?":""))}return{regex:new RegExp("^"+o+"\\/?$"),params:n}}var o=function(){function e(t){var e=this,n=t.interceptLocals,o=t.useHash;this.routes=[],this.handleLocalClick=function(t){var r=t.target;"A"===r.nodeName&&0===r.href.indexOf(location.origin)&&(t.preventDefault(),e.goTo(r.getAttribute("href")))},this.resolve=function(){var t=e.history.path(),r=e.current;e.routes.some(function(n){var o=t.match(n.regex),i=n.callbacks,s=i.onEnter,a=i.onUpdate;return o&&(o=o.filter(function(t){return void 0!==t}).reduce(function(t,r,e){return e&&(t[n.params[e-1]]=r),t},{}),r!==n?(e.current=n,r&&r.callbacks.onLeave(o),s(o)):a(o)),o})},this.history=o?r.createHashHistory():r.createPathHistory(),this.history.listen(this.resolve),n&&document.addEventListener("click",this.handleLocalClick)}return e.prototype.on=function(r,e){var o=this;void 0===e&&(e={});var i=t({path:r,callbacks:e},n(r));return this.routes.push(i),function(){return o.routes=o.routes.filter(function(t){return t!==i})}},e.prototype.goTo=function(t){this.history.go(t)},e}();exports.Router=o;
...
//# sourceMappingURL=https://alenaksu.github.io/tiny-lit/demo/src.7c4f3f3e.js.map