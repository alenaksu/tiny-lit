...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("./types"),t=[],s=[],o=10,n=100,r=window.requestAnimationFrame;let u=!1,i=0,c=!0;function l(e,t){let s=0;const o=e.length;for(;Date.now()<t&&s<o;){const t=e[s++];t.task(...t.args),t.args=void 0,t.scheduled=!1}e.splice(0,s)}function a(){i++;const e=Date.now()+o*Math.ceil(i*(1/n));l(t,e),l(s,e),t.length>0&&(s.push(...t),t.length=0),s.length>0?r(a):(u=!1,i=0)}function d(e){c=e}function h(o,n){o.scheduled=!0,n===e.JobPriority.Normal?t.push(o):n===e.JobPriority.Low&&s.push(o),u||(u=!0,r(a))}function f(t,s=e.JobPriority.Normal){const o={task:t,args:[],scheduled:!1,firstRun:!0};return(...e)=>{o.firstRun||!c?(o.firstRun=!1,t(...e)):(o.args=e,o.scheduled||h(o,s))}}exports.setEnabled=d,exports.enqueueJob=h,exports.scheduled=f;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./template");exports.Template=e.Template;var t=require("./scheduler");exports.scheduled=t.scheduled;const r=require("./template"),s=require("./utils");function n(e,t){n.instances.has(t)?n.instances.get(t).update(e.values):(n.instances.set(t,e),s.removeNodes(t.firstChild,null,t),t.appendChild(e.create()))}function a(e,...t){return new r.Template(e,t)}function u(e,...t){return new r.Template(e,t,"svg")}exports.render=n,n.instances=new WeakMap,exports.html=a,exports.svg=u;
...
//# sourceMappingURL=https://alenaksu.github.io/tiny-lit/demo/src.53e0bf96.js.map