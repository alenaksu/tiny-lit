parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"hSPJ":[function(require,module,exports) {
...
},{}],"eLKU":[function(require,module,exports) {
...
},{"./template":"qAKK","./scheduler":"jezz","./utils":"eLKU"}],"SmJf":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.withElement=t;var e=require("@tiny-lit/core");function t(t){return class extends t{constructor(){super(...arguments),this.state={},this.rendered=!1,this.renderCallbacks=[],this.renderRoot=this,this._onUpdated=(0,e.scheduled)(()=>{for(;this.renderCallbacks.length;)this.renderCallbacks.shift()();this.rendered?this.updated():this.firstUpdated(),this.rendered=!0})}attachShadow(e){return this.renderRoot=super.attachShadow.call(this,e)}connectedCallback(){this.update()}setState(e,t){const s=this.state;this.state=Object.assign(Object.assign({},s),"function"==typeof e?e(s,this):e),t&&this.renderCallbacks.push(t),this.update()}render(){return null}firstUpdated(){}beforeUpdate(){}updated(){}update(){this.beforeUpdate();const t=this.render();t&&(0,e.render)(t,this.renderRoot),this._onUpdated()}}}
},{"@tiny-lit/core":"ci4n"}],"xjSa":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Element=void 0;var e=require("./withProps"),t=require("./withElement");const r=(0,e.withProps)((0,t.withElement)(HTMLElement));exports.Element=r;
},{"./withProps":"hSPJ","./withElement":"SmJf"}],"Rxc5":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e={Element:!0,withProps:!0,withElement:!0};Object.defineProperty(exports,"Element",{enumerable:!0,get:function(){return t.Element}}),Object.defineProperty(exports,"withProps",{enumerable:!0,get:function(){return r.withProps}}),Object.defineProperty(exports,"withElement",{enumerable:!0,get:function(){return n.withElement}});var t=require("./Element"),r=require("./withProps"),n=require("./withElement"),o=require("@tiny-lit/core");Object.keys(o).forEach(function(t){"default"!==t&&"__esModule"!==t&&(Object.prototype.hasOwnProperty.call(e,t)||Object.defineProperty(exports,t,{enumerable:!0,get:function(){return o[t]}}))});
},{"./Element":"xjSa","./withProps":"hSPJ","./withElement":"SmJf","@tiny-lit/core":"ci4n"}],"gwaE":[function(require,module,exports) {
...
},{"@tiny-lit/element":"Rxc5","./style.js":"gwaE","secchiojs":"jE2t"}],"PdXR":[function(require,module,exports) {
...
},{"@tiny-lit/element":"Rxc5"}],"KQrV":[function(require,module,exports) {
...
},{"@tiny-lit/element":"Rxc5"}],"oPrN":[function(require,module,exports) {
...
},{"@tiny-lit/element":"Rxc5","./Dot":"PdXR","./Triangle":"KQrV"}],"wtU0":[function(require,module,exports) {
"use strict";var e;Object.defineProperty(exports,"__esModule",{value:!0}),exports.StoreEvents=void 0,exports.StoreEvents=e,function(e){e.Request="store::request",e.Dispatch="store::dispatch",e.Update="store::update"}(e||(exports.StoreEvents=e={}));
},{}],"Vl42":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.normalizeEvent=e,exports.requestStore=n,exports.createUpdateEvent=r,exports.createDispatchEvent=s;var t=require("./types");function e(t){return(e,n)=>("string"==typeof e&&(e={type:e,data:n}),t(e))}function n(e){const n=new CustomEvent(t.StoreEvents.Request,{detail:{}});return e.dispatchEvent(n),n.detail.store}function r(e,n){return new CustomEvent(t.StoreEvents.Update,{detail:{state:e,mutation:n}})}function s(e,n){return new CustomEvent(t.StoreEvents.Dispatch,{detail:{type:e,data:n}})}
},{"./types":"wtU0"}],"pJX1":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createStore=exports.Store=void 0;var t,s=require("./events");const e=Symbol(),i=(t,s)=>{for(const e in t)s.set(e,t[e])};class n{constructor(n={}){this[t]={},this.mutations=new Map,this.actions=new Map,this.listeners=new Set,this.dispatch=(0,s.normalizeEvent)(t=>{const s=this.actions;s.has(t.type)&&s.get(t.type)(this,t.data)}),this.commit=(0,s.normalizeEvent)(t=>{const s=this.mutations;s.has(t.type)&&(this[e]=s.get(t.type)(this.state,t.data)),this.listeners.forEach(s=>s(t))}),i(n.mutations,this.mutations),i(n.actions,this.actions),this[e]=Object.assign({},n.initialState),n.plugins&&n.plugins.forEach(t=>t(this))}get state(){return this[e]}subscribe(t){const{listeners:s}=this,e=s=>t(this.state,s);return s.add(e),t(this.state),()=>s.delete(e)}}exports.Store=n,t=e;const o=t=>new n(t);exports.createStore=o;
},{"./events":"Vl42"}],"Nb6r":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.withStore=n;var e=require("./types"),t=require("./events");function n(n){return class extends n{connectedCallback(){let n;if(super.connectedCallback&&super.connectedCallback(),n=(0,t.requestStore)(this)){const t=e=>this.onStateChange(e.detail.state,e.detail.mutation);n.addEventListener(e.StoreEvents.Update,t,!0),this.unsubscribe=n.removeEventListener.bind(this,e.StoreEvents.Update,t,!0),this.onStateChange(n.getStore().state)}}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.unsubscribe()}onStoreConnect(){}onStateChange(e,t){}dispatch(e,n){this.dispatchEvent((0,t.createDispatchEvent)(e,n))}}}
},{"./types":"wtU0","./events":"Vl42"}],"CNai":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.StoreProvider=void 0;var e=require("./types"),t=require("./events"),s=require("./store");class r extends HTMLElement{constructor(){super(),this.store=void 0,this.listeners=new WeakMap,this.onStateChange=((e,s)=>this.dispatchEvent((0,t.createUpdateEvent)(e,s))),this.onStoreRequest=(e=>{e.stopPropagation(),e.detail.store=this}),this.onStoreDispatch=(e=>{this.getStore().dispatch(e.detail)}),this.addEventListener(e.StoreEvents.Request,this.onStoreRequest,!0),this.addEventListener(e.StoreEvents.Dispatch,this.onStoreDispatch,!0),this.store=(0,s.createStore)(this.config),this.store.subscribe(this.onStateChange)}get config(){return{}}getStore(){return this.store}}exports.StoreProvider=r;
},{"./types":"wtU0","./events":"Vl42","./store":"pJX1"}],"zcht":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./store");Object.keys(e).forEach(function(r){"default"!==r&&"__esModule"!==r&&Object.defineProperty(exports,r,{enumerable:!0,get:function(){return e[r]}})});var r=require("./withStore");Object.keys(r).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return r[e]}})});var t=require("./StoreProvider");Object.keys(t).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return t[e]}})});var o=require("./types");Object.keys(o).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return o[e]}})});
},{"./store":"pJX1","./withStore":"Nb6r","./StoreProvider":"CNai","./types":"wtU0"}],"Hxbb":[function(require,module,exports) {
...
},{"@tiny-lit/store":"zcht","@tiny-lit/element":"Rxc5"}],"FuWg":[function(require,module,exports) {
...
},{"@tiny-lit/element":"Rxc5"}],"fqJ9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=()=>({path:()=>location.hash?location.hash.substring(1):"/",go(e){location.hash=`#${e}`},listen:e=>(addEventListener("hashchange",e),removeEventListener.bind(window,"hashchange",e))});exports.default=e;
},{}],"scmr":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=()=>({path:()=>location.pathname,go(e){history.pushState(null,document.title,e),dispatchEvent(new Event("pushstate"))},listen:e=>(addEventListener("popstate",e),addEventListener("pushstate",e),removeEventListener.bind(window,"popstate",e))});exports.default=e;
},{}],"ocfd":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"createHashHistory",{enumerable:!0,get:function(){return e.default}}),Object.defineProperty(exports,"createPathHistory",{enumerable:!0,get:function(){return t.default}});var e=r(require("./hash")),t=r(require("./path"));function r(e){return e&&e.__esModule?e:{default:e}}
},{"./hash":"fqJ9","./path":"scmr"}],"s6wJ":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Router=void 0;var t=require("./history");const e=/\/:([\w]+)(?:{([\w,]+)})?(\?)?/g;function s(t){let s,r=[],o=t;if("*"===t)return{regex:/.*/,params:[]};for(;s=e.exec(t);){const t=s[2]?`${s[2].split(",").join("|")}`:"[^/]+";r.push(s[1]),o=o.replace(s[0],`(?:\\/(${t}))${s[3]?"?":""}`)}return{regex:new RegExp(`^${o}\\/?$`),params:r}}class r{constructor({interceptLocals:e,useHash:s}){this.routes=[],this.handleLocalClick=(t=>{const e=t.target;"A"===e.nodeName&&0===e.href.indexOf(location.origin)&&(t.preventDefault(),this.goTo(e.getAttribute("href")))}),this.resolve=(()=>{const t=this.history.path(),e=this.current;this.routes.some(s=>{let r=t.match(s.regex);const{onEnter:o,onUpdate:i}=s.callbacks;return r&&(r=r.filter(t=>void 0!==t).reduce((t,e,r)=>(r&&(t[s.params[r-1]]=e),t),{}),e!==s?(this.current=s,e&&e.callbacks.onLeave(r),o(r)):i(r)),r})}),this.history=s?(0,t.createHashHistory)():(0,t.createPathHistory)(),this.history.listen(this.resolve),e&&document.addEventListener("click",this.handleLocalClick)}on(t,e={}){const r=Object.assign({path:t,callbacks:e},s(t));return this.routes.push(r),()=>this.routes=this.routes.filter(t=>t!==r)}goTo(t){this.history.go(t)}}exports.Router=r;
},{"./history":"ocfd"}],"sOBg":[function(require,module,exports) {
"use strict";var e;Object.defineProperty(exports,"__esModule",{value:!0}),exports.RouterEvents=void 0,exports.RouterEvents=e,function(e){e.Request="router::request",e.Change="router::change"}(e||(exports.RouterEvents=e={}));
},{}],"t583":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.requestRouter=t;var e=require("./types");function t(t){const r=new CustomEvent(e.RouterEvents.Request,{detail:{}});return t.dispatchEvent(r),r.detail.router}
},{"./types":"sOBg"}],"O96H":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.RouteElement=void 0;var e=require("./events");const t=new Set,n=e=>new Promise(n=>{if(!e||t.has(e))return n();{const o=document.createElement("script");o.onload=n,o.src=e,document.head.appendChild(o),t.add(e)}}),o=(e,t)=>n(e.getAttribute("module")).then(()=>customElements.whenDefined(t.localName));class s extends HTMLElement{connectedCallback(){const t=this.getAttribute("path"),n=this.getAttribute("component");if(t&&n&&(this.router=(0,e.requestRouter)(this))){const e=document.createElement(n);this.dispose=this.router.on(t,{onEnter:t=>{o(this,e).then(()=>this.appendChild(e)).then(()=>e.onRouteEnter&&e.onRouteEnter(t))},onUpdate:t=>{o(this,e).then(()=>e.onRouteUpdate&&e.onRouteUpdate(t))},onLeave:()=>{o(this,e).then(()=>e.onRouteLeave&&e.onRouteLeave()).then(()=>this.removeChild(e))}})}}disconnectedCallback(){this.dispose&&this.dispose()}}exports.RouteElement=s;
},{"./events":"t583"}],"pBSD":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.RouterProvider=void 0;var e=require("./router"),t=require("./types");class r extends HTMLElement{constructor(){super(...arguments),this.onRouterRequest=(e=>{e.detail.router=this.router})}connectedCallback(){document.body.addEventListener(t.RouterEvents.Request,this.onRouterRequest,!0),this.router||(this.router=new e.Router({interceptLocals:this.hasAttribute("intercept-locals"),useHash:this.hasAttribute("use-hash")})),Promise.resolve().then(this.router.resolve)}disconnectedCallback(){document.body.removeEventListener(t.RouterEvents.Request,this.onRouterRequest,!0)}}exports.RouterProvider=r;
},{"./router":"s6wJ","./types":"sOBg"}],"a9wn":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"Router",{enumerable:!0,get:function(){return e.Router}}),Object.defineProperty(exports,"RouteElement",{enumerable:!0,get:function(){return r.RouteElement}}),Object.defineProperty(exports,"RouterProvider",{enumerable:!0,get:function(){return t.RouterProvider}});var e=require("./router"),r=require("./RouteElement"),t=require("./RouterProvider");
},{"./router":"s6wJ","./RouteElement":"O96H","./RouterProvider":"pBSD"}],"uBxZ":[function(require,module,exports) {
...
},{"./todo/index.js":"x8N4","./scheduler/index.js":"oPrN","./store/index.js":"Hxbb","./svg/index.js":"FuWg","@tiny-lit/router":"a9wn"}]},{},["uBxZ"], null)
//# sourceMappingURL=https://alenaksu.github.io/tiny-lit/demo/src.26c85216.js.map